...
- Run Pytest for snapshot planning, validation, error handling, and migration dry-run behavior.
- Do not require live Elasticsearch clusters in unit tests; use fixtures or marked integration tests.
